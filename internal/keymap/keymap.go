...
var Outline = []Binding{
	...
	{Keys: "o", Short: "o open link", Long: "open the item's link — a [[linked note]] in $EDITOR, or (web) a markdown [text](url) link in a new browser tab; chooser if it has several", Group: "edit", TUI: true, Web: true, TUIFooter: true, WebFooter: true},
...
var Map = []Binding{
	...
	{Keys: "o", Long: "open the focused item's link: a [[linked note]], or (web) a markdown [text](url) link in a new browser tab (chooser if several)", Group: "edit", TUI: true, Web: true},
